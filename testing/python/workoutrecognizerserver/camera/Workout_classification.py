...
def workout(data):
    df = minMaxNorm(data)
    ori_data = pd.read_csv('combined.csv')
    ...
    if 1 in pred:
        a1 = 1
        d = pd.read_csv('a1_s4_r1.csv') #obtaining reference file for activity 1
        acc_v, acc_t = accuracy(d, data)
    elif 2 in pred:
        a2 = 1
        d = pd.read_csv('a2_s4_r1.csv') #obtaining reference file for activity 2
        acc_v, acc_t = accuracy(d, data)
    elif 3 in pred:
        a3 = 1
        d = pd.read_csv('a3_s4_r1.csv') #obtaining reference file for activity 3
        acc_v, acc_t = accuracy(d, data)
    elif 4 in pred:
        a4 = 1
        d = pd.read_csv('a4_s4_r1.csv') #obtaining reference file for activity 4
        acc_v, acc_t = accuracy(d, data)
    else:
        a5 = 1
        d = pd.read_csv('a5_s4_r1.csv') #obtaining reference file for activity 5
        acc_v, acc_t = accuracy(d, data)
